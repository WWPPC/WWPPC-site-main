...
<template>
    <div class="fullBlock stretchBlock">
        ...
        <div class="organizerTable">
            ...
            <HomeAboutCreditsCard name="Erik Ji" username="erikji" roles="Problemsetter<br>Logistics & Outreach<br>Website Developer" img="/img/erik-ji.jpg" grade="Junior (HSS)" codeforces="passwordisa" github="erikji" discord="688018118492291080" bio="CF CM,gold,AIME,won Battlecode 2025 HS,golf"></HomeAboutCreditsCard>
